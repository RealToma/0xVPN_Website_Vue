<template>
  <section id="docs" class="bg-[#1B255C] pt-[100px] pb-[70px]">
    <div class="container px-2 lg:px-0">
      <h3
        data-aos="fade-up"
        class="text-center font-medium text-xl lg:text-[32px] leading-[43px] text-white"
      >
        A Unified Vision
      </h3>
      <h1
      ...
      >
        ...
        <a
          class="underline"
          target="_blank"
          href="https://etherscan.io/address/0x24c3484bdf9211eeaa17868df93a2a9413c79053#code"
          >deployed on 6 chains</a
        >
      ...
      >
        <br /><br />
        We are aiming to become the first EVM-compatible Layer-2 VPN network, and use $VPN as the
        native token for our ecosystem, allowing developers to create an application layer on top of
        our decentralized VPN infrastructure.
      </p>
    </div>
  </section>
</template>
