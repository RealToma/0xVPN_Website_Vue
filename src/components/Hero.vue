...
<template>
  <section class="w-full hero-section pb-24 mt-24">
    <div class="container px-5 lg:px-0 pt-[155px] flex">
      <div class="w-full lg:w-[50%] pt-[50px] pb-[40px]">
        <h1
          data-aos="fade-up"
          class="font-bold text-4xl lg:text-[42px] leading-10 lg:leading-[64px] text-white"
        >
          The first L2-Chain VPN,
          revolutionizing Internet Privacy.
        ...
        >
          0xVPN is a censorship resistant Layer-2 protocol with an integrated marketplace for a decentralized Peer-to-Peer Virtual Private Network.
        </p>
        <div class="w-full flex gap-[23px]">
          <a href="#desktop-client"
...
.hero-section {
  ...
  background-image: url('/final-hero-bg.png');
}
</style>
