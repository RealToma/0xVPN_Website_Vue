      ...
      <div class="w-full flex flex-col lg:flex-row gap-8">
        ...
        <div>
          ...
          <p data-aos="fade-up" class="text-base lg:text-[26px] leading-7 font-normal text-white mt-[27px]">
            Uniswap Liquidity Pool tokens have been locked for 2 years, <a class="underline" href="https://app.uncx.network/amm/uni-v2/pair/0xa4e1e7187e8cff09a3a113b9d3438f06264b1803" target="_blank">check here</a>.
          </p>
          <div data-aos="fade-up" class="flex flex-col lg:flex-row gap-[21px] mt-[75px]">
            ...
            <a
              href="https://www.etherscan.com/address/0xf898bae008cd85046431ab0a75f00689d6aa1b1c"
              target="_blank"
